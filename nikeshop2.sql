...
INSERT INTO `category` VALUES (1,'Shoes'),(2,'Shirts'),(3,'Shorts'),(4,'Caps');
...
CREATE TABLE `iorder` (
  ...
  `time_order` varchar(100) NOT NULL,
  `time_delivery` varchar(100) NOT NULL,
  `total_payment` double NOT NULL,
  `status` tinyint(1) NOT NULL,
  `phone` varchar(30) NOT NULL,
  `name_receiver` varchar(200) NOT NULL,
  `address_reciver` varchar(200) NOT NULL,
...
INSERT INTO `iorder` VALUES (1,'nothing','10:14 AM','none',3.519,0,'1234567','user abc','Los Angeles','mail2@gmail.com');
...
-- Dump completed on 2023-06-09 11:27:28
